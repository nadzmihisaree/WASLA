                 ...
                 <div class="position-relative" style="background: url('<?php bloginfo('template_directory'); ?>/assets/images/member.png') center center no-repeat ;background-size: cover; padding-bottom: clamp(50px,12vw,167px);">
                     ...
                     <div class="position-relative px-sm-5">
                                     ...
                                     <div class="">
                                         ...
                                         <div class="member-radio d-sm-flex justify-content-evenly mb-3">
                                             ...
                                             <div class="align-items-center d-flex text-start">
                                                 <label for="exampleInputName" class="fs-15 fw-500 me-3" style="color: rgba(56, 56, 56, 0.92);">
                                                     <p class="m-0">Other : </p>
                                                 </label>
                                                 <input type="name" class="form-control member-input" id="exampleInputName">
                                             </div>
                                         </div>
                                         ...
                                         <div class="row">
                                             <div class="col-sm">
                                                 <div class="text-start">
                                                     <label for="exampleInputName" class="fs-15 fw-600" style="color: rgba(53, 53, 53, 0.92);">
                                                         <p>First Name</p>
                                                     </label>
                                                     <input type="name" class="form-control member-input2" id="exampleInputName">
                                                 </div>
                                             </div>
                                             <div class="col-sm">
                                                 <div class="text-start">
                         ...
                         <div class="row mt-5 justify-content-between justify-content-sm-end">
                             ...
                             <div class="col-auto">
                                 <a href="#">
                                     <button class="member-butt2">Cancel</button>
                                 </a>
                             </div>
                         </div>
                         <!--/ Section - 04 (buttons) -->
 ...
 <footer class="footer">
     <div class="row justify-content-between">
         <div class="col-md">
             <p class="fs-20 fw-500" style="color: #b5b5b5">
                 Membership opens the door to all possibilities
             </p>
             <p class="fs-40 fw-500 mb-5" style="color: #f9f9f9">WASLA ASSOCIATION</p>
         </div>
     ...
     <div class="d-flex" style="margin-top: clamp(50px, 7vw, 106px); margin-bottom: clamp(20px, 5vw, 57px)">
         ...
         <div>
             <img src="<?php bloginfo('template_directory'); ?>/assets/images/twitter.png" class="social-icon" />
         </div>
     </div>
