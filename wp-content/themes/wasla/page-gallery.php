...
<section class="pt-5" style="padding-bottom: clamp(50px, 8vw, 100px)">
    <div class="row justify-content-between m-0 px-lg-5 ">
        <div class="col-auto">
            ...
            <select class="gallery-dropdown fs-18 fw-600" style="color: #404040;">
                <option value="1" class="fs-18 fw-600" style="color: #404040;">All Category</option>
                <option value="2" class="fs-18 fw-600" style="color: #404040;">All Category2</option>
                <option value="3" class="fs-18 fw-600" style="color: #404040;">All Category3</option>
                <option value="4" class="fs-18 fw-600" style="color: #404040;">All Category4</option>
            </select>
        ...
        <div class="col-auto align-items-center d-flex">
            ...
            <select class="gallery-dropdown2 fs-18 fw-600" style="color: rgba(69, 69, 69, 0.71);">>
                <option value="1" class="fs-18 fw-600" style="color: rgba(69, 69, 69, 0.71);">Titles</option>
                <option value="2" class="fs-18 fw-600" style="color: rgba(69, 69, 69, 0.71);">All Category2</option>
                <option value="3" class="fs-18 fw-600" style="color: rgba(69, 69, 69, 0.71);">All Category3</option>
                <option value="4" class="fs-18 fw-600" style="color: rgba(69, 69, 69, 0.71);">All Category4</option>
            </select>
        </div>
    </div>
</section>
...
<!-- Section - 03 (gallery) -->
<div class="row container mx-auto m-0">
    <div class="col-4 gallery-col px-4" >
...
<section>
    <div class="d-flex justify-content-center mt-5" style=" margin-bottom: clamp(50px,11vw,167px);">
        <button class="load-more gallery-butt fs-20 fw-600 text-center">
            Load More
        </button>
    </div>
</section>
